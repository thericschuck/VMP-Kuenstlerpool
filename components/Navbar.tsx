...
export default function Navbar() {
  ...
  // ── Gliding underline: update position ─────────────────────────
  useEffect(() => {
  ...
  return (
    <>
      ...
      <header
        ...
        style={{ background: scrolled ? 'var(--color-cream)' : 'transparent' }}
      >
        <nav
        ...
        >
          ...
          <div ref={navContainerRef} className="relative hidden md:block">
            ...
            {/* Single gliding underline – moves with CSS transition */}
            <span
          ...
          >
            ...
            <span
              ...
              style={{ background: 'var(--color-ink)', opacity: menuOpen ? 0 : 1 }}
            />
            <span
              className="block h-0.5 w-6 rounded-full transition-all duration-300 origin-center"
              style={{
